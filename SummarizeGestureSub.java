...
public class SummarizeGestureSub extends Summarize {
    ...
    {
        while (res.next()) {
            System.out.println( metric_name + "\t" + res.getString(1) + "\t" + res.getString(2) + "\t" + res.getDouble(3) + "\t" + res.getDouble(4) + "\t" + res.getDouble(5) + "\t" + res.getDouble(6) + "\t" + res.getDouble(7) + "\t" + res.getDouble(8) + "\t" + res.getDouble(9) + "\t" + res.getDouble(10) + "\t" + res.getDouble(11) + "\t" + res.getDouble(12) + "\t" + res.getDouble(13));
        }
    }
}
